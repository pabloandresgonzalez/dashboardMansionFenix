  ...
  <div class="col-12 mt-4">
    <div class="card mb-4">
      <div class="card-header pb-0 p-4">
        ...
        <p class="text-sm mb-1">¡Actualiza o adquiere tu fondo y disfruta de beneficios exclusivos! </p>
      </div>
          ...
          <div class="card card-plain">
            <div class="card-header pb-2">
              <div class="d-flex align-items-center justify-content-between">
                <h3 class="font-weight-bolder text-info text-gradient mb-0">Fondo de {{ $membresia->name }}</h3>
