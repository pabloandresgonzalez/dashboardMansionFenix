        ...
        <div class="row">
          <div class="col-lg-6 col-7">
            ...
            <p class="text-sm mb-0">
              Control y activación de mis Bóvedas
            </p>
          </div>
          ...
          <div class="card card-plain">
            <div class="card-header pb-2">
              <div class="d-flex align-items-center justify-content-between">
                <h4 class="font-weight-bolder text-info text-gradient mb-0">Renovar Bóveda de {{ $membership->membership }}</h4>
              ...
              <p class="mt-2 mb-2 text-sm">Renovar la Bóveda de la cuenta <strong>{{ $membership->user_email }}</strong>.</p>              
            </div>
            <div class="card-body pt-1">
              <form class="" method="POST" enctype="multipart/form-data" action="{{ secure_url('/mismembership/'.$membership->id) }}">
                @csrf @method('POST')

                <div class="form-group mb-1">
                  <label for="membership" class="form-control-label mb-1">Bóveda</label>
            ...
            <div class="card-footer text-center pt-0 px-lg-2 px-1">
              <p class="mb-2 text-sm mx-auto">
                Valor de la Bóveda <strong>$ {{ $membership->membership}}</strong>
              </p>              
            </div>
          </div>
        </form>
