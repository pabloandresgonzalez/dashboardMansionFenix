              ...
              <tr>
                ...
                <td >
                  <div class="avatar-group d-flex align-items-center">
                    ...
                    @endif  
      					    <span class="mx-2">
      					       <a href="{{ url('/user-management/'.$membership->id.'/detail') }}" class="d-flex align-items-center">
          ...
          <div class="card card-plain">
            <div class="card-header pb-2">
              <div class="d-flex align-items-center justify-content-between">
                <h4 class="font-weight-bolder text-info text-gradient mb-0">Activar Fonfo de {{ $membership->membership }}</h4>
