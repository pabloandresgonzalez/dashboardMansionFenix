...
<div class="page-header section-height-75">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n-2">
                    <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../assets/img/curved-images/Capture3.png')"></div>
                </div>
            </div>
        </div>
    </div>
