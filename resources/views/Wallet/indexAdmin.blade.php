          ...
          <div class="card card-plain">
                  ...
                  <?php
                    if($Wallet->status === 'Aprobada' || $Wallet->status === 'Rechazada') {
                        ...
                        <div class="form-group mb-1">
                          <label for="hash" class="form-control-label mb-1">Detalle de hash</label>
                          <textarea class="form-control" type="text" name="hash" id="hash" placeholder="Maximo 256 caractres."></textarea>
                        </div> 
            ...
            <div class="card-footer text-center pt-0 px-lg-2 px-1">
              <p class="mb-2 text-sm mx-auto">
                Valor traslado + 5% de administración <strong> = $<?php echo $Wallet->value + $Wallet->value * 5 / 100; ?></strong>
              </p>
            </div>
          </div>
        </form>
