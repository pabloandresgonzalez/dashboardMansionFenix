      ...
      <div class="row">
        <div class="col-xl-6 mb-xl-0 mb-4">
          <div class="card bg-transparent shadow-xl">
            <div class="overflow-hidden position-relative border-radius-xl" style="background-image: url('{{ secure_asset('assets/img/curved-images/curved14.jpg') }}');">
              ...
              <div class="card-body position-relative z-index-1 p-3">
                ...
                <div class="d-flex">
                  ...
                  <div class="ms-auto w-20 d-flex align-items-end justify-content-end">
                    <img src="{{ secure_asset('../img/phoenix coin v29_1.png') }}" class="img-fluid shadow border-radius-xl">
                  </div>
                </div>
              </div>
            </div>
              ...
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                  ...
                  <div class="d-flex flex-column">
                    ...
                    <span class="text-xs">
                        {{ $Wallet->created_at ? $Wallet->created_at->format('d M Y, h:i A') : 'Fecha no disponible' }}
                    </span>
      ...
      <div class="modal-content">
        <div class="modal-body p-4">
          <div class="card card-plain">
            <div class="card-header pb-2">
              <div class="d-flex align-items-center justify-content-between">
                <h4 class="font-weight-bolder text-info text-gradient mb-0">Detalle producción de la Bóveda de {{ $membership->membership }}</h4>
                <img src="{{ secure_asset('../img/phoenix coin v29_1.png') }}" class="img-fluid shadow border-radius-xl ms-3" style="width: 40px; height: auto; border-radius: 50%">
              </div>
              <p class="mt-1 mb-2 text-sm">Utilidad Bóveda de <strong>${{ number_format($membership->total_value, 2) }}</strong></p>
            </div>
              ...
              <div class="card mx-1">
                <div class="table-responsive">
                  <table class="table align-items-center table-sm mb-0">
                    <thead>
                      <tr>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Bóveda</th>
