...
<head>
    ...
    <title>Notificación de Solicitud de Traslado</title>
...
<body>
    <header>
        <h2>¡Se ha enviado una solicitud de traslado de {{ $Wallet->currency }}!</h2>
    </header>
    <div class="container">   
        <p>Estimado(a) Admin,</p>
        <p>Se recibió una solicitud de traslado de {{ $Wallet->currency }} con los siguientes detalles:</p>     
        ...
        <p>Para más detalles, puedes revisar gestión de billetera en el Portal.</p> 
